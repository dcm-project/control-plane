...
var (
	// ErrInvalidServiceType indicates the service type is not one of the allowed values.
	ErrInvalidServiceType = errors.New("invalid service type: must be one of the allowed service types")
