...
// NetworkSpec Provider-agnostic network specification.
//
// Includes common fields (service_type, metadata, provider_hints)
// plus fields for ports and optional routing_level.
//
...
type NetworkSpec struct {
	...
	//
	//
	// Example: [{"address":"10.96.45.12","name":"http","port":80,"scope":"internal"},{"address":"34.123.45.67","name":"http","port":80,"scope":"external"}]
	...
	// RoutingLevel Optional routing tier for the service.
	//
...
// NetworkSpecRoutingLevel Optional routing tier for the service.
//
// - network: L4 (TCP/UDP) routing
// - application: L7 (HTTP/gRPC) routing
//
